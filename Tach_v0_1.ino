...
volatile unsigned long recentMicros; //Time of most recent revolution
volatile unsigned long previousMicros; //Time of previous most recent revolution
...
{
  //Calculate RPM
  secPerRev = (recentMicros - previousMicros)/1000000.0;
  rpm = (1/secPerRev)*60.0;

  if(millis() - recentMicros/1000 >= 1000)
  {
    rpm = 0;
  }
